...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument('--geometry', choices=('fit', 'fill', 'native'), default='native',
    ...
    ap.add_argument('--no-quiz-export', dest='quiz_export', action='store_false',
                    help='Quizfragen NICHT zusätzlich als Importdatei ablegen '
                         '(Standard: .xlsx/.txt neben der .story)')
