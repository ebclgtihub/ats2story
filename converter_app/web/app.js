...
// von Python gepusht, wenn eine neuere Fassung veröffentlicht ist
window.onUpdate = (info) => {
  ...
  b.onclick = () => {
    try { window.pywebview.api.open_release_page(info.url || ''); } catch (e) { /* ignore */ }
  };
};
...
const OPTIONS = {
  ...
  optCleanBg: true, optGeometry: 'fit', optSingle: false, optNoExams: true,
  optQuizBank: true, optQuizFont: '18.5', optQuizExport: false, optQuizSlides: false,
};
